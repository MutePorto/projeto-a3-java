...
public class Menu extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        listMenu1.addItem(new Model_Menu("8", "Alunos", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("8", "Professores", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("5", "Turmas", Model_Menu.MenuType.MENU));        
    ...
    private void initComponents() {
        ...
        listMenu1 = new composicao.ListMenu<>();
    ...
    private composicao.ListMenu<String> listMenu1;
