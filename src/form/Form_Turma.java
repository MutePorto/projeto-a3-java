...
public class Form_Turma extends javax.swing.JPanel {
    ...
    public Form_Turma() {
        ...
        table.addRow(new Object[]{"Analise e Desenvolvimento de Sistemas"});
        table.addRow(new Object[]{"Introdução Algoritimo e Logica de Programação"});
        table.addRow(new Object[]{"Modelagem de software"});
    }
